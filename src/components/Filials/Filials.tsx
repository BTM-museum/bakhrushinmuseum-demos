...
const data: IFilials[] = [
    ...
    { id: 5, title: "Дом-музей Ермоловой", imageUrl: "https://placehold.jp/600x600.png", imageAddUrl: dop1, position: "Адрес Филиала 6", link: "/", type: "filial", backgroundColor: 'rgb(187, 133, 171)'},
    { id: 6, title: "Музей-квартира мейерхольда", imageUrl: "https://placehold.jp/600x600.png", imageAddUrl: dop2, position: "Адрес Филиала 7", link: "/", type: "filial", backgroundColor: 'rgb(225, 8, 0)'},
    { id: 7, title: "Музей-квартира мироновы-менкареа", imageUrl: "https://placehold.jp/600x600.png", imageAddUrl: dop3, position: "Адрес Филиала 8", link: "/", type: "filial", backgroundColor: 'rgb(224, 192, 159)'},
